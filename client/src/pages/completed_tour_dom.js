                ...
                <div className="continue_tour_space_between">
                    <div className="continue_tour">
                        ...
                        <div className="continue_tour_main">
                            ...
                            <div className="continue_tour_winners">
                                <p>
                                    Победители:
                                </p>

                                <p className="continue_tour_text">
                                    Степанова Екатерина Леоновна,
                                    Зубов Ян Петрович,
                                    Шевцов Егор Кириллович,
                                    Семина Валерия Михайловна,
                                    Поляков Михаил Кириллович
                                </p>
                            </div>
                        </div>
                    </div>

                    <section  className="continue_tour_bt competed_tour_bt">
